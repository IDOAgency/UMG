...
//
//         <A HREF="javascript:doNothing()" onClick="setDateField(document.mydocument.forms[0].myDateField);top.newWin = window.open('calendar.html','cal','dependent=yes,width=210,height=230,screenX=200,screenY=300,titlebar=yes')">
...
function setInitialDate() 
{
    ...
    // 00 is converted to 1900 so we need this to compensate to year 2000 and so forth
    if(calDate.getFullYear() <= 1990) 
    {
	  calDate.setFullYear(calDate.getFullYear() + 100);
    }
