...
public class FamilyHandler extends SecureHandler {
  ...
  public Notepad getFamilyNotepad(Context context, int userId) {
    ...
    return new Notepad(contents, 0, 15, "Family", 9, columnNames);
  }
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\FamilyHandler.class
