...
public class Selection extends MilestoneDataEntity implements Cloneable, NotepadContentObject, Comparable {
  ...
  protected String productionCodeGroup = "";
  ...
  public String getProductionGroupCode() { return this.productionCodeGroup; }
  
  public void setProductionGroupCode(String productionCodeGroup) { this.productionCodeGroup = productionCodeGroup; }
  ...
  public String toString() {
    return " \n--Selection--\ngetSelectionID " + 
      ...
      "getProductionGroupCode" + getProductionGroupCode() + "\n" + 
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\Selection.class
