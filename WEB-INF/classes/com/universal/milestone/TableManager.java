  ...
  public void setNotepadQuery(Context context, int UserId, Notepad notepad) {
    if (notepad != null) {
      ...
      if (MilestoneHelper.isStringNotEmpty(descriptionSearch))
        tableQuery = String.valueOf(tableQuery) + MilestoneHelper.addQueryParams(tableQuery, " description " + 
            MilestoneHelper.setWildCardsEscapeSingleQuotes(descriptionSearch)); 
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\TableManager.class
