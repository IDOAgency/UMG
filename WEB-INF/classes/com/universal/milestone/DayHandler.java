...
public class DayHandler extends SecureHandler {
  ...
  public Notepad getDayNotepad(Context context, int userId) {
    ...
    return new Notepad(contents, 0, 15, "Day Type", 6, columnNames);
  }
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\DayHandler.class
