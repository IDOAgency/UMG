...
public class DreamWorksPromoScheduleForPrintSubHandler extends SecureHandler {
  ...
  protected static void fillDreamWorksPromoScheduleForPrint(XStyleSheet report, Context context) {
    ...
    try {
      ...
      Collections.sort(sortedConfigVector, new StringReverseComparator());
      ...
      for (int n = 0; n < sortedConfigVector.size(); n++) {
        ...
        String config = (sortedConfigVector.elementAt(n) != null) ? (String)sortedConfigVector.elementAt(n) : "";
        ...
        table_contents.setColWidth(13, 100);
        ...
        columnHeaderTable.setObject(nextRow, 1, "Title");
        columnHeaderTable.setObject(nextRow, 2, "File Maint\n(PFM)");
        columnHeaderTable.setObject(nextRow, 3, "CD-CS\nCopy to\nEd");
        columnHeaderTable.setObject(nextRow, 4, "Copy to\nArt");
        columnHeaderTable.setObject(nextRow, 5, "Final Art\nDue");
        columnHeaderTable.setObject(nextRow, 6, "Ref\nApp/Enter\nRMS");
        columnHeaderTable.setObject(nextRow, 7, "Order\nParts");
        columnHeaderTable.setObject(nextRow, 8, "Film &\nParts Ship");
        columnHeaderTable.setObject(nextRow, 9, "BOM");
        columnHeaderTable.setObject(nextRow, 10, "Enhn\nTest\nAppvd");
        columnHeaderTable.setObject(nextRow, 11, "DJs\nShip\nHome\nOffice");
        columnHeaderTable.setObject(nextRow, 12, "DJs\nShip\nField");
        columnHeaderTable.setObject(nextRow, 13, "DJs\nShip\nRadio");
        ...
        if (monthTable != null) {
          ...
          for (int x = 0; x < monthArray.length; x++) {
            ...
            monthTableLens.setSpan(nextRow, 0, new Dimension(11, 1));
            monthTableLens.setObject(nextRow, 0, monthNameString);
            monthTableLens.setSpan(nextRow, 13, new Dimension(1, 1));
            ...
            monthTableLens.setAlignment(nextRow, 13, 4);
            ...
            for (int i = 0; i < selections.size(); i++) {
              ...
              if (sel.getPrefixID() != null && sel.getPrefixID().getAbbreviation() != null)
                selectionNo = String.valueOf(sel.getPrefixID().getAbbreviation()) + " " + selectionNo; 
              ...
              String DJRvend = "";
              if (tasks != null)
                for (subTableRows = 0; subTableRows < tasks.size(); subTableRows++) {
                  task = (ScheduledTask)tasks.get(subTableRows);
                  if (task != null && task.getDueDate() != null) {
                    ...
                    if (taskAbbrev.equalsIgnoreCase("SFD")) {
                      ...
                      TAvend = taskVendor;
                    } else if (taskAbbrev.equalsIgnoreCase("DJHO")) {
                      DJHO = dueDate;
                      DJHOcom = completionDate;
                      DJHOvend = taskVendor;
                    } else if (taskAbbrev.equalsIgnoreCase("DJFS")) {
                      DJFS = dueDate;
                      DJFScom = completionDate;
                      DJFSvend = taskVendor;
                    } else if (taskAbbrev.equalsIgnoreCase("DJR")) {
                      DJRvend = taskVendor;
                    } 
                    task = null;
                  } 
              ...
              if (multOtherContacts.size() > 4) {
                subTableRows = 3 + multOtherContacts.size();
              } else {
                subTableRows = 7;
              } 
              ...
              String[] checkStrings = { comment, artist, title, pack, label };
              ...
              subTable.setObject(nextRow, 4, FPC);
              ...
              subTable.setObject(nextRow, 5, FAD);
              ...
              subTable.setObject(nextRow, 6, MA);
              ...
              subTable.setObject(nextRow, 7, PO);
              subTable.setAlignment(nextRow, 7, 10);
              subTable.setBackground(nextRow, 7, SHADED_AREA_COLOR);
              subTable.setColBorder(nextRow, 7, 266240);
              subTable.setObject(nextRow, 8, PFS);
              ...
              subTable.setObject(nextRow, 9, BMS);
              ...
              subTable.setObject(nextRow, 10, TA);
              ...
              subTable.setObject(nextRow, 11, DJHO);
              ...
              subTable.setObject(nextRow, 12, DJFS);
              ...
              SimpleDateFormat dueDateFormatter = new SimpleDateFormat("M/d");
              if (monthNameString.equals("")) {
                subTable.setObject(nextRow, 13, "");
              } else {
                Calendar streetDateCal = MilestoneHelper.getDate(monthNameString);
                String formattedStreetDate = "";
                try {
                  formattedStreetDate = dueDateFormatter.format(streetDateCal.getTime());
                } catch (Exception exception) {}
                subTable.setObject(nextRow, 13, formattedStreetDate);
              } 
              ...
              subTable.setObject(nextRow + 1, 0, artist);
              subTable.setFont(nextRow + 1, 0, new Font("Arial", 1, 7));
              if (multOtherContacts.size() == 0) {
                subTable.setObject(nextRow + 1, 1, "");
              } else {
                subTable.setObject(nextRow + 1, 1, multOtherContacts.elementAt(0));
              } 
              subTable.setFont(nextRow + 1, 1, new Font("Arial", 1, 7));
              subTable.setObject(nextRow + 1, 2, SFMcom);
              subTable.setObject(nextRow + 1, 3, PCFcom);
              subTable.setObject(nextRow + 1, 4, FPCcom);
              subTable.setObject(nextRow + 1, 5, FADcom);
              subTable.setObject(nextRow + 1, 6, MAcom);
              subTable.setObject(nextRow + 1, 7, POcom);
              subTable.setObject(nextRow + 1, 8, PFScom);
              subTable.setObject(nextRow + 1, 9, BMScom);
              subTable.setObject(nextRow + 1, 10, TAcom);
              subTable.setObject(nextRow + 1, 11, DJHOcom);
              subTable.setObject(nextRow + 1, 12, DJFScom);
              ...
              if (multOtherContacts.size() < 2) {
                ...
                subTable.setObject(nextRow + 1, 1, multOtherContacts.elementAt(1));
              } 
              subTable.setObject(nextRow + 1, 2, SFMvend);
              subTable.setObject(nextRow + 1, 3, PCFvend);
              subTable.setObject(nextRow + 1, 4, FPCvend);
              subTable.setObject(nextRow + 1, 5, FADvend);
              subTable.setObject(nextRow + 1, 6, LCcom);
              subTable.setObject(nextRow + 1, 7, POvend);
              subTable.setObject(nextRow + 1, 8, TPScom);
              subTable.setObject(nextRow + 1, 9, BMSvend);
              subTable.setObject(nextRow + 1, 10, TAcom);
              subTable.setObject(nextRow + 1, 11, DJHOcom);
              subTable.setObject(nextRow + 1, 12, DJFSvend);
              subTable.setObject(nextRow + 1, 13, DJRvend);
              subTable.setAlignment(nextRow + 1, 0, 10);
              subTable.setAlignment(nextRow + 1, 1, 9);
              subTable.setAlignment(nextRow + 1, 2, 10);
              subTable.setAlignment(nextRow + 1, 3, 10);
              subTable.setAlignment(nextRow + 1, 4, 10);
              ...
              subTable.setRowBorderColor(nextRow + 1, Color.white);
              subTable.setRowHeight(nextRow + 1, 9);
              subTable.setObject(nextRow + 1, 8, MAvend);
              if (multOtherContacts.size() < 3) {
                subTable.setObject(nextRow + 1, 1, "");
              } else {
                subTable.setObject(nextRow + 1, 1, multOtherContacts.elementAt(2));
              } 
              subTable.setObject(nextRow + 1, 6, MAvend);
              subTable.setObject(nextRow + 1, 8, PFScom);
              subTable.setObject(nextRow + 1, 11, DJHOvend);
              subTable.setObject(nextRow + 1, 10, TAvend);
              subTable.setAlignment(nextRow + 1, 0, 10);
              subTable.setAlignment(nextRow + 1, 1, 9);
              subTable.setAlignment(nextRow + 1, 2, 10);
              subTable.setAlignment(nextRow + 1, 3, 10);
              ...
              subTable.setRowBorderColor(nextRow + 1, Color.white);
              subTable.setRowHeight(nextRow + 1, 9);
              subTable.setObject(nextRow + 1, 8, LCvend);
              if (multOtherContacts.size() < 4) {
                subTable.setObject(nextRow + 1, 1, "");
              } else {
                subTable.setObject(nextRow + 1, 1, multOtherContacts.elementAt(3));
              } 
              subTable.setObject(nextRow + 1, 6, LCvend);
              subTable.setObject(nextRow + 1, 8, TPSvend);
              subTable.setAlignment(nextRow + 1, 0, 10);
              subTable.setAlignment(nextRow + 1, 1, 9);
              subTable.setAlignment(nextRow + 1, 2, 10);
              subTable.setAlignment(nextRow + 1, 3, 10);
              ...
              subTable.setAlignment(nextRow + 1, 13, 10);
              if (multOtherContacts.size() > 4) {
                int extraRows = multOtherContacts.size() - 4;
                for (int k = 0; k < extraRows; k++) {
                  ...
                  subTable.setAlignment(nextRow + 1, 12, 10);
                  subTable.setAlignment(nextRow + 1, 13, 10);
                  subTable.setObject(nextRow + 1, 1, multOtherContacts.elementAt(k + 4));
                } 
              } 
              nextRow++;
              ...
              subTable.setSpan(nextRow + 1, 1, new Dimension(13, 1));
              subTable.setAlignment(nextRow + 1, 1, 9);
              subTable.setFont(nextRow + 1, 0, new Font("Arial", 1, 7));
    ...
    for (int i = 0; i < selections.size(); i++) {
      ...
      if (sel != null) {
        ...
        if (typeString.startsWith("Promo")) {
          if (productCatString.equals("Advances")) {
            typeConfigString = "Full Length Advance Promos";
          } else {
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\DreamWorksPromoScheduleForPrintSubHandler.class
