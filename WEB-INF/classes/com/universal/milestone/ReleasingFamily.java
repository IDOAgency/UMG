        ...
        for (int i = 0; i < families.size(); i++) {
          ...
          if (family != null) {
            ...
            if (family.getStructureID() == labelFamilyId)
              isDefault = true; 
            labelReleasingFamilies.add(new ReleasingFamily(family
                  .getStructureID(), 
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\ReleasingFamily.class
