  ...
  public static Vector getTaskDueSelectionsForReport(Context context, ComponentLog log) {
    ...
    while (connector.more()) {
      try {
        ...
        selection.setProductCategory((ProductCategory)MilestoneHelper.getLookupObject(connector.getField("product_line"), 
        ...
        selection.setSelectionConfig(MilestoneHelper.getSelectionConfigObject(connector.getField("configuration"), 
              Cache.getSelectionConfigs()));
        selection.setSelectionSubConfig(MilestoneHelper.getSelectionSubConfigObject(connector.getField("sub_configuration"), 
        ...
        selection.setGenre((Genre)MilestoneHelper.getLookupObject(connector.getField("genre"), 
              Cache.getMusicTypes()));
        ...
        selection.setSelectionStatus((SelectionStatus)MilestoneHelper.getLookupObject(connector.getField("status"), 
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\TaskDueDateByTitleForPrintHandler.class
