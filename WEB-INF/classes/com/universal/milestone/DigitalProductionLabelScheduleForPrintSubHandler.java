...
public class DigitalProductionLabelScheduleForPrintSubHandler extends SecureHandler {
  ...
  protected static void fillDigitalProductionLabelScheduleUpdateForPrint(XStyleSheet report, Context context) {
    ...
    try {
      ...
      for (int n = 0; n < sortedConfigVector.size(); n++) {
        ...
        table_contents.setColWidth(7, 65);
        ...
        table_contents.setColWidth(12, 75);
        ...
        if (monthTable != null) {
          ...
          for (int x = 0; x < monthArray.length; x++) {
            ...
            columnHeaderTable.setColWidth(7, 65);
            ...
            columnHeaderTable.setColWidth(13, 100);
            ...
            columnHeaderTable.setObject(nextRow, 7, "Sched\nType");
            columnHeaderTable.setObject(nextRow, 8, "eCommerce\nNotified");
            columnHeaderTable.setObject(nextRow, 9, "RMS\nEntry");
            columnHeaderTable.setObject(nextRow, 10, "Complete\nPFM");
            columnHeaderTable.setObject(nextRow, 11, "Graphics\nDue");
            columnHeaderTable.setObject(nextRow, 12, "Audio\nDue");
            columnHeaderTable.setObject(nextRow, 13, "Legal\nClearance\nsent to\neCommerce");
            ...
            for (int j = 0; j < selections.size(); j++) {
              ...
              String schedTypeCode = sel.getSelectionConfig().getSelectionConfigurationAbbreviation();
              String schedType = "";
              if (schedTypeCode.equals("DO")) {
                schedType = "D";
              } else if (schedTypeCode.equals("DAS")) {
                schedType = "A";
              } else if (schedTypeCode.equals("DSWP")) {
                schedType = "S";
              } else if (schedTypeCode.equals("DPTP")) {
                schedType = "P";
              } else if (schedTypeCode.equals("PTC")) {
                schedType = "PTC";
              } 
              String pfmComments = "";
              Pfm pfm = new Pfm();
              ...
              subTable.setRowBorderColor(nextRow, 7, Color.white);
              ...
              subTable.setObject(nextRow, 7, schedType);
              ...
              if (tasks != null)
                for (int z = 0; z < tasks.size(); z++) {
                  ...
                  if (task != null) {
                    ...
                    if (completionDate.equals("9/9/99") && task.getScheduledTaskStatus().equalsIgnoreCase("Done"))
                      completionDate = "Done"; 
                    ...
                    if (taskAbbrev.equalsIgnoreCase("NOT")) {
                      NOT = dueDate;
                      NOTcom = String.valueOf(completionDate) + taskVendor;
                      ...
                      GRA = dueDate;
                      GRAcom = String.valueOf(completionDate) + taskVendor;
                    } else if (taskAbbrev.equalsIgnoreCase("WAV")) {
                      WAV = dueDate;
                      WAVcom = String.valueOf(completionDate) + taskVendor;
                    } else if (taskAbbrev.equalsIgnoreCase("BAS")) {
                      BAS = dueDate;
                      BAScom = String.valueOf(completionDate) + taskVendor;
                    } 
                    task = null;
                  } 
                }  
              ...
              subTable.setObject(nextRow, 8, NOT);
              subTable.setBackground(nextRow, 8, Color.lightGray);
              subTable.setObject(nextRow + 1, 8, NOTcom);
              subTable.setObject(nextRow, 9, RMS);
              subTable.setBackground(nextRow, 9, Color.lightGray);
              subTable.setObject(nextRow + 1, 9, RMScom);
              subTable.setObject(nextRow, 10, PFM);
              subTable.setBackground(nextRow, 10, Color.lightGray);
              subTable.setObject(nextRow + 1, 10, PFMcom);
              subTable.setBackground(nextRow, 11, Color.lightGray);
              subTable.setObject(nextRow, 11, GRA);
              subTable.setObject(nextRow + 1, 11, GRAcom);
              subTable.setBackground(nextRow, 12, Color.lightGray);
              subTable.setObject(nextRow, 12, WAV);
              subTable.setObject(nextRow + 1, 12, WAVcom);
              ...
              for (int colIdx = 8; colIdx <= 13; colIdx++) {
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\DigitalProductionLabelScheduleForPrintSubHandler.class
