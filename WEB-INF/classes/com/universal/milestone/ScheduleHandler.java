...
public class ScheduleHandler extends SecureHandler {
  ...
  public Notepad getTaskNotepad(Context context, int userId, int releaseId) {
    ...
    return new Notepad(contents, 0, 15, "Tasks", 2, columnNames);
  }
    ...
    if (taskID > 0 && rows >= 0) {
      ...
      if (sessionSchedule != null) {
        ...
        if (sessionTask != null) {
          ...
          ScheduledTask dbTask = ScheduleManager.getInstance().getScheduledTask(sessionSchedule
              .getSelectionID(), taskID);
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\ScheduleHandler.class
