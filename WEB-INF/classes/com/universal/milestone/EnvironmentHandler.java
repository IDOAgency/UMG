...
public class EnvironmentHandler extends SecureHandler {
  ...
  public Notepad getEnvironmentNotepad(Context context, int userId) {
    ...
    return new Notepad(contents, 0, 15, "Environment", 21, columnNames);
  }
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\EnvironmentHandler.class
