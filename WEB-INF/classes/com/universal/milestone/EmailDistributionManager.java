    ...
    if (notepad != null) {
      ...
      if (MilestoneHelper.isStringNotEmpty(firstNameSearch))
        query = String.valueOf(query) + 
          MilestoneHelper.addQueryParams(query, " vi_email_distribution_header.first_Name " + MilestoneHelper.setWildCardsEscapeSingleQuotes(firstNameSearch)); 
      if (MilestoneHelper.isStringNotEmpty(lastNameSearch))
        query = String.valueOf(query) + 
          MilestoneHelper.addQueryParams(query, " vi_email_distribution_header.last_Name " + MilestoneHelper.setWildCardsEscapeSingleQuotes(lastNameSearch)); 
  ...
  public static boolean sendEmailDistribution(String subject, String body, String recipients, String copyRecipients, String attachment) {
    ...
    try {
      ...
      if (!result) {
        ...
        destListMilestone.add(new SessionUserEmailObj("mark.cole@umusic.com", true));
        destListMilestone.add(new SessionUserEmailObj("marla.hall@umusic.com", true));
