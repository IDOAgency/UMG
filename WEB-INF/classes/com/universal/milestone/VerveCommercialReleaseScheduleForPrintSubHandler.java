...
public class VerveCommercialReleaseScheduleForPrintSubHandler extends SecureHandler {
  ...
  public String getDescription() { return "Verve Commercial Release Schedule Report"; }
  ...
  protected static void fillVerveScheduleUpdateForPrint(XStyleSheet report, Context context) {
    ...
    try {
      ...
      table_contents.setObject(nextRow, 0, "Japan");
      table_contents.setAlignment(nextRow, 0, 1);
      table_contents.setObject(nextRow, 1, "Europe");
      table_contents.setAlignment(nextRow, 1, 1);
      table_contents.setObject(nextRow, 2, "US");
      table_contents.setAlignment(nextRow, 2, 1);
      table_contents.setObject(nextRow, 3, "Artist");
      table_contents.setAlignment(nextRow, 3, 1);
      table_contents.setObject(nextRow, 4, "Title");
      table_contents.setAlignment(nextRow, 4, 1);
      table_contents.setObject(nextRow, 5, "Product Category");
      table_contents.setAlignment(nextRow, 5, 1);
      table_contents.setObject(nextRow, 6, "Price");
      table_contents.setAlignment(nextRow, 6, 4);
      table_contents.setObject(nextRow, 7, "Label");
      table_contents.setAlignment(nextRow, 7, 2);
      table_contents.setObject(nextRow, 8, "Local Product #");
      table_contents.setAlignment(nextRow, 8, 1);
      table_contents.setObject(nextRow, 9, "UPC");
      table_contents.setAlignment(nextRow, 9, 2);
      table_contents.setObject(nextRow, 10, "Project #");
      table_contents.setAlignment(nextRow, 10, 1);
      ...
      for (int n = 0; n < groupedByMonth.size(); n++) {
        ...
        monthTableLens.setColWidth(0, 50);
        monthTableLens.setColWidth(1, 50);
        monthTableLens.setColWidth(2, 50);
        monthTableLens.setColWidth(3, 130);
        monthTableLens.setColWidth(4, 210);
        monthTableLens.setColWidth(5, 80);
        monthTableLens.setColWidth(6, 60);
        monthTableLens.setColWidth(7, 100);
        monthTableLens.setColWidth(8, 70);
        monthTableLens.setColWidth(9, 85);
        monthTableLens.setColWidth(10, 70);
        ...
        for (int i = 0; i < selectionsInMonth.size(); i++) {
          ...
          subTable.setColWidth(1, 50);
          subTable.setColWidth(2, 50);
          subTable.setColWidth(3, 130);
          subTable.setColWidth(4, 210);
          subTable.setColWidth(5, 80);
          subTable.setColWidth(6, 60);
          subTable.setColWidth(7, 100);
          ...
          String japanDate = " " + sel.getOtherContact();
          ...
          subTable.setObject(nextRow, 0, japanDate);
          subTable.setAlignment(nextRow, 0, 9);
          subTable.setObject(nextRow, 1, intlDate);
          subTable.setAlignment(nextRow, 1, 9);
          subTable.setObject(nextRow, 2, streetDate);
          subTable.setAlignment(nextRow, 2, 9);
          subTable.setObject(nextRow, 3, sel.getArtist().trim());
          subTable.setAlignment(nextRow, 3, 9);
          subTable.setObject(nextRow, 4, sel.getTitle());
          subTable.setAlignment(nextRow, 4, 9);
          subTable.setObject(nextRow, 5, prodCategoryName);
          subTable.setAlignment(nextRow, 5, 9);
          subTable.setObject(nextRow, 6, "$" + price);
          subTable.setAlignment(nextRow, 6, 12);
          subTable.setObject(nextRow, 7, labelName);
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\VerveCommercialReleaseScheduleForPrintSubHandler.class
