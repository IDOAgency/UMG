...
/*     */ 
/*     */ 
/*     */ public class PhysicalProductActivitySummaryForPrintSubHandler
...
/*  70 */     this.log = application.getLog("hNsl");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 753 */     Vector finalVector = new Vector();
/* 754 */     Vector selectionIds = new Vector();
/*     */     
/* 756 */     String selIdStr = "";
/*     */     
/* 758 */     int selId = 0;
/*     */     
/* 760 */     String selIdStrSearch = "";
/*     */     
/* 762 */     int selIdSearch = 0;
/*     */ 
/*     */     
/* 765 */     MilestoneHelper.setSelectionSorting(originalVector, 27);
/* 766 */     Collections.sort(originalVector);
/*     */     
/* 768 */     for (int i = 0; i < originalVector.size(); i++) {
/*     */ 
/*     */       
/* 771 */       Selection sel = (Selection)originalVector.elementAt(i);
/* 772 */       selId = sel.getSelectionID();
/* 773 */       selIdStr = Integer.toString(sel.getSelectionID());
/*     */ 
/*     */ 
/*     */       
/* 777 */       if (!selectionIds.contains(selIdStr)) {
/*     */ 
/*     */ 
/*     */         
/* 781 */         for (int j = 0; j < originalVector.size(); j++) {
/*     */ 
/*     */           
/* 784 */           Selection selSearch = (Selection)originalVector.elementAt(j);
/* 785 */           selIdSearch = selSearch.getSelectionID();
/* 786 */           selIdStrSearch = Integer.toString(selSearch.getSelectionID());
/*     */ 
/*     */           
/* 789 */           if (selIdSearch == selId) {
/* 790 */             finalVector.add(selSearch);
/*     */           }
/*     */         } 
/*     */ 
/*     */ 
/*     */         
/* 796 */         selectionIds.add(selIdStrSearch);
/*     */       } 
/*     */     } 
/*     */ 
/*     */ 
/*     */     
/* 802 */     return finalVector;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 814 */     ReportElement elementToHide = report.getElement(elementName);
/* 815 */     elementToHide.setVisible(false);
/*     */   }
/*     */ }
