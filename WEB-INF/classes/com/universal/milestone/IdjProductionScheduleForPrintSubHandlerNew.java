...
public class IdjProductionScheduleForPrintSubHandlerNew extends SecureHandler {
  ...
  protected static void fillIdjProductionScheduleForPrint(XStyleSheet report, Context context) {
    ...
    try {
      ...
      for (int n = 0; n < sortedConfigVector.size(); n++) {
        ...
        table_contents.setColWidth(10, 72);
        table_contents.setColWidth(11, 90);
        table_contents.setColWidth(12, 70);
        table_contents.setColWidth(13, 90);
        table_contents.setColWidth(14, 77);
        ...
        columnHeaderTable.setColWidth(10, 72);
        columnHeaderTable.setColWidth(11, 90);
        columnHeaderTable.setColWidth(12, 70);
        columnHeaderTable.setColWidth(13, 90);
        columnHeaderTable.setColWidth(14, 77);
        ...
        columnHeaderTable.setObject(nextRow, 3, "Selection\nUPC\nConfig");
        ...
        columnHeaderTable.setObject(nextRow, 7, "Readers\nCirc");
        columnHeaderTable.setObject(nextRow, 8, "BOM");
        columnHeaderTable.setObject(nextRow, 9, "Film\nShips");
        columnHeaderTable.setObject(nextRow, 10, "Parts\nOrder");
        columnHeaderTable.setObject(nextRow, 11, "Masters\nShip");
        columnHeaderTable.setObject(nextRow, 12, "Manf\nCopy\nDue");
        columnHeaderTable.setObject(nextRow, 13, "Tests\nApproved");
        columnHeaderTable.setObject(nextRow, 14, "Finish\nGoods\nDepot");
            ...
            if (dateTable != null) {
              ...
              for (int dIndex = 0; dIndex < dateArray.length; dIndex++) {
                ...
                for (int i = 0; i < selections.size(); i++) {
                  ...
                  subTable.setObject(nextRow, 7, STIC);
                  ...
                  subTable.setObject(nextRow, 9, FP);
                  ...
                  subTable.setObject(nextRow + 1, 7, STICcom);
                  subTable.setObject(nextRow + 1, 8, BOMcom);
                  subTable.setObject(nextRow + 1, 9, FPcom);
                  subTable.setObject(nextRow + 1, 10, MCcom);
                  subTable.setObject(nextRow + 1, 11, MASTERScom);
                  subTable.setObject(nextRow + 1, 12, DJcom);
                  subTable.setObject(nextRow + 1, 13, FILMcom);
                  subTable.setObject(nextRow + 1, 14, DEPOTcom);
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\IdjProductionScheduleForPrintSubHandlerNew.class
