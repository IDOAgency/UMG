...
public class NashRelScheduleForPrintSubHandler extends SecureHandler {
  ...
  public NashRelScheduleForPrintSubHandler(GeminiApplication application) {
    ...
    this.log = application.getLog("hNashProd");
  }
  ...
  protected static void fillNashRelScheduleForPrint(XStyleSheet report, Context context) {
    ...
    try {
      ...
      for (int n = 0; n < companyArray.length; n++) {
        ...
        table_contents.setColWidth(1, 500);
        ...
        nextRow = 0;
        columnHeaderTable = new DefaultTableLens(1, 7);
        columnHeaderTable.setColWidth(0, 260);
        columnHeaderTable.setColWidth(1, 500);
        columnHeaderTable.setColWidth(2, 150);
        columnHeaderTable.setColWidth(3, 90);
        ...
        columnHeaderTable.setAlignment(nextRow, 3, 20);
        ...
        columnHeaderTable.setObject(nextRow, 5, "Impact\nDate");
        ...
        if (subconfigTable != null) {
          ...
          for (int scIndex = 0; scIndex < subconfigsArray.length; scIndex++) {
            ...
            for (int i = 0; i < selections.size(); i++) {
              ...
              subTable.setObject(nextRow, 5, MilestoneHelper.getFormatedDate(sel.getImpactDate()));
              subTable.setObject(nextRow, 6, comment);
              ...
              String[] checkStrings = { comment.trim(), sel.getArtist().trim(), sel.getTitle().trim() };
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\NashRelScheduleForPrintSubHandler.class
