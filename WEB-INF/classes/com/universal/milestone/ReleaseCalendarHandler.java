...
public class ReleaseCalendarHandler extends SecureHandler {
  ...
  private HashMap getReleaseCalendarSelections(Form form, Context context) {
    ...
    while (connector.more()) {
      ...
      selection.setSelectionConfig(SelectionManager.getSelectionConfigObject(connector.getField("configuration"), 
            Cache.getSelectionConfigs()));
      selection.setSelectionSubConfig(SelectionManager.getSelectionSubConfigObject(connector.getField("sub_configuration"), 
...
/* Location:              D:\Documents\NetBeansProjects\milestone2 Local.war!\WEB-INF\classes\co\\universal\milestone\ReleaseCalendarHandler.class
