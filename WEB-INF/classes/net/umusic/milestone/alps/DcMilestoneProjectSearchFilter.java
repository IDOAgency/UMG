...
public class DcMilestoneProjectSearchFilter implements Serializable {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DcMilestoneProjectSearchFilter))
      return false; 
    DcMilestoneProjectSearchFilter other = (DcMilestoneProjectSearchFilter)obj;
    if (obj == null)
      return false; 
    if (this == obj)
      return true; 
  ...
  private static TypeDesc typeDesc = new TypeDesc(DcMilestoneProjectSearchFilter.class, true);
  
  static  {
    typeDesc.setXmlType(new QName("http://alps.milestone.umusic.net/", "dcMilestoneProjectSearchFilter"));
