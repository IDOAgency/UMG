...
var deleteCommand = "<%= inf.getServletCmdURL(MilestoneConstants.CMD_RELEASE_WEEK_EDIT_DELETE) %>";
var save = "<%= MilestoneConstants.CMD_RELEASE_WEEK_EDIT_SAVE%>";
var saveNew = "<%= MilestoneConstants.CMD_RELEASE_WEEK_EDIT_SAVE_NEW%>";
...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>release-week-editor-javascript.js"></script>
...
<% if (form.getRenderableValue("cmd").equals("release-week-editor"))
	{
%>
	<body topmargin="0" leftmargin="0" onLoad="processLoad('Cycle');">
<%}
	else
	{
%>
	<body topmargin="0" leftmargin="0" onLoad="processLoad('Name');">
<%} %>
		...
		<tr>
			<td valign="top" width="100%">
				...
				<tr>
					...
					<td colspan="2"><%= form.getElement("theName")%></td>
				</tr>
				<tr>
					<td class="label">Cycle</td>
					<td colspan="2"><%= form.getElement("Cycle") %></td>
				</tr>
				<tr>
					<td class="label">Start Date</td>
					<td><%= form.getElement("StartDate") %></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="label">Sol. Date</td>
					<td><%= form.getElement("SolDate") %></td>
				</tr>
			</table>
		</td>
	</tr>
