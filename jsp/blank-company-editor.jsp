...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>blank-company-editor-javascript.js"></script>
...
<tr valign="middle" align="left">
  ...
  <td width="170"><span class="title">Company</span></td>
  <td width="85"></td>
  <td width="85"></td>
  <td width="85"></td>
  <td width="85">
...
<tr>
 ...
 <%}%>
  ...
  <%  //start company form %>
    ...
    <tr><td align="center"><b><h4>Milestone System<br><br><br>Please select a Company on the left panel to view</h4></b></td></tr>
  </table>
		</td>
	</tr>
