...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>blank-family-editor-javascript.js"></script>
...
<tr valign="middle" align="left">
	...
	<td width="170"><span class="title">Family</span></td>
  <td width="85"></td>
	<td width="85"></td>
	<td width="85"></td>
	<td width="85">
...
<tr>
  ...
  <%}%>
    ...
    <tr><td align="center"><b><h4>Milestone System<br><br><br>Please select a Family on the left panel to view</h4></b></td></tr>
  </table>
		</td>
	</tr>
