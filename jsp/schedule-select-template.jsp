...
<script type="text/javascript" language="JavaScript">
  ...
  var editor = "<%= inf.getServletCmdURL(MilestoneConstants.CMD_SCHEDULE_SELECT_TEMPLATE)%>";
 ...
 <script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>schedule-select-template-javascript.js"></script>
		      ...
		      <tr>
			   ...
			   <tr>
				   ...
				   <td colspan="5" align="center" bgcolor="#eeeeee">
				     <table align="center" width="300" border="1" cellspacing="0" cellpadding="1">
                 <%
