...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>blank-label-editor-javascript.js"></script>
...
<table width="780" cellpadding="0" border="0">
  <tr valign="middle" align="left">
	...
	<td width="170"><span class="title">Label</span></td>
  <td width="85"></td>
	<td width="85"></td>
	<td width="85">
  <!--
  ...
  <%}%>
    ...
    <tr><td align="center"><b><h4>Milestone System<br><br><br>Please select a Label on the left panel to view</h4></b></td></tr>
  </table>
		</td>
	</tr>
