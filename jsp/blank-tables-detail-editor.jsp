...
//global variables needed in include tables-detail-editor-javascript.js
  ...
  var deleteCommand = "<%= inf.getServletCmdURL(MilestoneConstants.CMD_TABLES_DETAIL_EDITOR) %>";
...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>blank-table-detail-editor-javascript.js"></script>
...
<table width="780" cellpadding="0" border="0">
 ...
 <%}%>
	...
	<% //start tables detail form %>
	<td bgcolor="lavender" valign="top" colspan="6" width="100%">
		<table width="100%" height="100%" cellpadding="5" border="0">
		<tr>
			<td width="100%" align="center"><b><h4>Milestone System<br><br><br>Please search for Table Details on the left panel to this view </h4></b></td>
	</tr>
	<tr><td valign="bottom">
	</td></tr>
	</td>
