...
<script type="text/javascript" language="JavaScript" src="<%= inf.getHtmlDirectory() %>blank-price-code-editor-javascript.js"></script>
...
<tr>
 ...
 %>
  ...
  %>
    ...
    <tr><td align="center"><b><h4>Milestone System<br><br><br>Please search for Price Code on the left panel to this view </h4></b></td></tr>
  </table>
