		...
		<tr>
			<td valign="top" width="100%">
				...
				<tr>
					...
					<td><%= form.getElement("reportto") %></td>
				</tr>
				<tr>
				...
				<table width="100%">
				<tr>
					<td colspan="4" class="label">User Environment</td>
				</tr>
				<%
					out.println("<tr>");
					...
					for (int i=0; i < cAcl.size(); i++)
					{
			            	  Environment environment = (Environment)cAcl.elementAt(i);
                                          ...
                                          {
						out.println("<td>");
						out.println("<a href=\"#\" title=\"family: " + MilestoneHelper.getStructureName(environment.getParentID()) + "\">");
